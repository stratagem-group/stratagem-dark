...
Panel {
  id: root
  moduleName: "stratagem.power"
  ipcTarget: "stratagem.power"
  ...
  function setProfile(profile) {
    ...
    actionProc.command = ["stratagem-powerprofiles-set", root.discharging ? "battery" : "ac", profile]
  ...
  Process {
    id: batteryProc
    command: ["stratagem-battery-status", "--shell"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateKeyValue(text, "battery") }
  }

  Process {
    id: profilesProc
    command: ["stratagem-powerprofiles-list", "--active-state"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateProfiles(text) }
  }

  Process {
    id: systemProc
    command: ["stratagem-system-stats"]
