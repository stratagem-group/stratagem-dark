...
// Visual reference + live playground for stratagem-shell's common UI
// components. Summon with `stratagem dev ui-preview`, or directly via:
//   stratagem-shell shell summon stratagem.dev-gallery "{}"
//
...
Item {
  ...
  function open(payloadJson) {
    ...
    // Optional { section: "button" } in the payload lets `stratagem dev
  ...
  function requestClose() {
    if (shell && typeof shell.hide === "function") shell.hide("stratagem.dev-gallery")
  ...
  FloatingWindow {
    id: window
    title: "STRATAGEM DARK shell – dev gallery"
    ...
    onVisibleChanged: {
      if (!visible && !root.closingFromHost && root.shell && typeof root.shell.hide === "function")
        root.shell.hide("stratagem.dev-gallery")
    }
      ...
      PanelKeyCatcher {
        ...
        Column {
          ...
          Column {
            ...
            Text {
              text: "STRATAGEM DARK shell · dev gallery"
          ...
          Column {
            ...
            Text {
              text: "Style.font.* is the shell-wide type scale. Themes ship a single "
                ...
                + "set it with `stratagem font set <name>`."
            ...
            BorderSurface {
              ...
              Column {
                ...
                Dropdown {
                  ...
                  label: "Center anchor"
                  fontFamily: root.fontFamily
                  options: ["stratagem.clock", "stratagem.weather", "stratagem.power"]
              ...
              Column {
                ...
                SearchableDropdown {
                  ...
                  options: [
                    ...
                    { value: "stratagem.power", label: "Power", description: "Charge level + power profile" },
                    ...
                    { value: "stratagem-menu", label: "STRATAGEM DARK menu", description: "Launcher / system menu" },
