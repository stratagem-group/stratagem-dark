...
Item {
  ...
  // Injected by stratagem-shell; defaults to the session STRATAGEM_DARK_PATH.
  ...
  property string imageDirs: Quickshell.env("STRATAGEM_DARK_IMAGE_SELECTOR_DIRS") || Quickshell.env("STRATAGEM_DARK_IMAGE_SELECTOR_DIR") || Quickshell.env("STRATAGEM_DARK_STOCK_BACKGROUNDS_DIR") || (stateHome + "/stratagem/current/theme/backgrounds")
  property string imageRows: ""
  property string loadedImageRows: ""
  property string selectionFile: Quickshell.env("STRATAGEM_DARK_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("STRATAGEM_DARK_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("STRATAGEM_DARK_IMAGE_SELECTOR_SELECTED")
  ...
  function scriptPath(name) {
    return stratagemPath + "/shell/plugins/image-picker/" + name
  }
  ...
  // Lifecycle hooks invoked by stratagem-shell summon/hide. shell.summon(id,
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "stratagem-image-selector"
