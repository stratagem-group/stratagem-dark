...
-- Used for STRATAGEM DARK extension-style folders such as default/hypr/apps,
-- default/hypr/bindings, and ~/.local/state/stratagem/toggles/hypr.
-- Pass a module prefix for normal package.path modules, e.g.
--   require_all.files(paths.stratagem_path .. "/default/hypr/apps", "default.hypr.apps")
