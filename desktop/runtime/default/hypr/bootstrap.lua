-- Hyprland bootstrap for STRATAGEM DARK's Lua module path.

local home = os.getenv("HOME")
local reload_prefixes = {
  "default.hypr",
  "hypr",
  "stratagem.current.theme",
}
...
-- STRATAGEM DARK defaults from $STRATAGEM_DARK_PATH.
package.path = home
  .. "/.local/state/?.lua;"
  .. home
  .. "/.config/?.lua;"
  .. (os.getenv("STRATAGEM_DARK_PATH") or "/usr/share/stratagem")
  .. "/?.lua;"
  .. package.path
