...
-- layer-shell surfaces such as STRATAGEM DARK panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "stratagem-shell shell toggle stratagem.clipboard")
