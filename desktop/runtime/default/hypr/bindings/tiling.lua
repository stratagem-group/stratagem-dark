...
o.bind("CTRL + ALT + DELETE", "Close all windows", "stratagem-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "stratagem-hyprland-window-pop")
o.bind("SUPER + ALT + Home", "Save window width", "stratagem-hyprland-window-width save")
o.bind("SUPER + Home", "Restore window width", "stratagem-hyprland-window-width restore")
o.bind("SUPER + L", "Toggle workspace layout", "stratagem-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + SLASH", "Monitor scaling up", "stratagem-hyprland-monitor-scaling up")
o.bind("SUPER + ALT + SLASH", "Monitor scaling down", "stratagem-hyprland-monitor-scaling down")
