...
local nvidia = paths.stratagem_path .. "/bin/stratagem-hw-nvidia"
local nvidia_gsp = paths.stratagem_path .. "/bin/stratagem-hw-nvidia-gsp"
local nvidia_without_gsp = paths.stratagem_path .. "/bin/stratagem-hw-nvidia-without-gsp"
