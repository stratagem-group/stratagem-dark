...
from geometry and color, not reduced text clarity. Scanlines/glow are optional and
must never obstruct text. No mandatory flicker, animation, or motion effects.

The SVG is an original text-based concept, not a finalized trademark/logo clearance.
