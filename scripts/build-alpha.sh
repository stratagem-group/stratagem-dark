...
tar --sort=name --mtime="@$SOURCE_DATE_EPOCH" --owner=0 --group=0 --numeric-owner -I 'zstd -T0 -6' -cf "$out/stratagem-dark-0.2.0-alpha2-x86_64-bundle.tar.zst" -C "$work" bundle
